  ...
  inkstone: {
    ...
    mermaid: {
      ...
      themeVariables: {
        ...
        arrowheadColor: '#466f57',
        relationColor: '#466f57',
      },
    },
    selection: {
      background: '#ded8cb',
  ...
  slate: {
    ...
    mermaid: {
      ...
      themeVariables: {
        ...
        arrowheadColor: '#587a85',
        relationColor: '#587a85',
      },
    },
    selection: {
      background: '#d8dddd',
  ...
  mono: {
    ...
    mermaid: {
      ...
      themeVariables: {
        ...
        arrowheadColor: '#3b6f48',
        relationColor: '#3b6f48',
      },
    },
    selection: {
      background: '#dcdcd8',
  ...
  nocturne: {
    ...
    mermaid: {
      ...
      themeVariables: {
        ...
        arrowheadColor: '#86a878',
        relationColor: '#86a878',
      },
    },
    selection: {
      background: '#394035',
