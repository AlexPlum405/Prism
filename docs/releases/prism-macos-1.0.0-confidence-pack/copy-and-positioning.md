...
- macOS first, Windows/Linux staged

## Avoid

Do not claim:

- "Fully replaces Typora"
- "Fully replaces MiaoYan"
- "All platforms officially supported"
- "Perfect export for every document"
- "AI-powered writing platform"

## macOS 1.0.0 Release Notes Draft

### Prism 1.0.0 for macOS

This is Prism's first official macOS release.

Prism 1.0.0 focuses on local Markdown writing, reliable preview, and export workflows that are easier to trust and diagnose. It supports Markdown and common text documents, rich preview rendering for diagrams and formulas, workspace navigation, document diagnostics, and HTML/PDF/PNG/DOCX export.

### Highlights

- Local-first Markdown and text document editing
- Edit / split / preview writing modes
- Diagram and formula preview: Mermaid, PlantUML, Markmap, KaTeX
...
macOS is the first official release platform. Windows and Linux are planned, but they require real-device validation before being labeled official releases.
